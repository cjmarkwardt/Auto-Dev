...
[Claude Integration](ClaudeIntegration.md#guards-against-racing-the-working-tree)), so script runs
and AI-driven edits never contend for the same working tree at once. `HasRunningScripts` also
